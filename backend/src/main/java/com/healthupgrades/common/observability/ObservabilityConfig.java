...
/**
 * Wires the response header and the scheduled-task observations, neither of which Spring Boot wires
 * itself.
 *
 * <p>The third hand-wired piece, STOMP, is registered from {@code WebSocketConfig} because that is where
