...
import com.healthupgrades.upgrade.api.UpgradeDto; // reused published presentation model
import com.healthupgrades.upgrade.api.UpgradeWebMapper; // reused to map embedded upgrades
import com.healthupgrades.upgrade.domain.HealthUpgrade; // domain aggregate in each bucket
