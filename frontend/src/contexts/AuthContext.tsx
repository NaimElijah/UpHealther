 ...
 * session.
 *
 * A 401 on any later request is handled elsewhere, by the axios interceptor in `api/client.ts`, which
 * ends the session on the request that found the token expired. The mount-time check below covers the
 * page load: it clears the session on any failed `/api/auth/me`.
 */
